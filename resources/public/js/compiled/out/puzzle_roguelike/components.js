...
puzzle_roguelike.components.sprite_to_string = (function puzzle_roguelike$components$sprite_to_string(p__57655){
var vec__57657 = p__57655;
var x = cljs.core.nth.call(null,vec__57657,(0),null);
var y = cljs.core.nth.call(null,vec__57657,(1),null);
...
var vec__57660 = puzzle_roguelike.images.sprite_image_size;
var img_size_x = cljs.core.nth.call(null,vec__57660,(0),null);
var img_size_y = cljs.core.nth.call(null,vec__57660,(1),null);
...
var sprite = cljs.core.apply.call(null,cljs.core.str,cljs.core.map.call(null,((function (vec__57660,img_size_x,img_size_y,entity,symbol,color){
return (function (p1__57658_SHARP_){
return [cljs.core.str(p1__57658_SHARP_),cljs.core.str("px ")].join('');
});})(vec__57660,img_size_x,img_size_y,entity,symbol,color))
...
return null;
});})(vec__57660,img_size_x,img_size_y,entity,symbol,color,sprite))
...
puzzle_roguelike.components.player_view = (function puzzle_roguelike$components$player_view(p__57661,out_chan){
var vec__57664 = p__57661;
var x = cljs.core.nth.call(null,vec__57664,(0),null);
var y = cljs.core.nth.call(null,vec__57664,(1),null);
var vec__57665 = puzzle_roguelike.images.sprite_image_size;
var img_size_x = cljs.core.nth.call(null,vec__57665,(0),null);
var img_size_y = cljs.core.nth.call(null,vec__57665,(1),null);
...
return null;
});})(vec__57665,img_size_x,img_size_y,pos_x,pos_y,sprite,vec__57664,x,y))
...
var vec__57674 = puzzle_roguelike.map.map_size;
var width = cljs.core.nth.call(null,vec__57674,(0),null);
var height = cljs.core.nth.call(null,vec__57674,(1),null);
var vec__57675 = position;
var player_x = cljs.core.nth.call(null,vec__57675,(0),null);
var player_y = cljs.core.nth.call(null,vec__57675,(1),null);
...
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.map","div.map",-288957849),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"height","height",1025178622),(puzzle_roguelike.components.tile_size * height),new cljs.core.Keyword(null,"width","width",-384071477),(puzzle_roguelike.components.tile_size * width),new cljs.core.Keyword(null,"flex-basis","flex-basis",983188475),(puzzle_roguelike.components.tile_size * width)], null)], null),(function (){var iter__17598__auto__ = ((function (vec__57674,width,height,vec__57675,player_x,player_y,pixel_position){
return (function puzzle_roguelike$components$map_view_$_iter__57676(s__57677){
return (new cljs.core.LazySeq(null,((function (vec__57674,width,height,vec__57675,player_x,player_y,pixel_position){
return (function (){
var s__57677__$1 = s__57677;
while(true){
var temp__4425__auto__ = cljs.core.seq.call(null,s__57677__$1);
if(temp__4425__auto__){
var xs__4977__auto__ = temp__4425__auto__;
var y = cljs.core.first.call(null,xs__4977__auto__);
var iterys__17594__auto__ = ((function (s__57677__$1,y,xs__4977__auto__,temp__4425__auto__,vec__57674,width,height,vec__57675,player_x,player_y,pixel_position){
return (function puzzle_roguelike$components$map_view_$_iter__57676_$_iter__57678(s__57679){
return (new cljs.core.LazySeq(null,((function (s__57677__$1,y,xs__4977__auto__,temp__4425__auto__,vec__57674,width,height,vec__57675,player_x,player_y,pixel_position){
return (function (){
var s__57679__$1 = s__57679;
while(true){
var temp__4425__auto____$1 = cljs.core.seq.call(null,s__57679__$1);
if(temp__4425__auto____$1){
var s__57679__$2 = temp__4425__auto____$1;
if(cljs.core.chunked_seq_QMARK_.call(null,s__57679__$2)){
var c__17596__auto__ = cljs.core.chunk_first.call(null,s__57679__$2);
var size__17597__auto__ = cljs.core.count.call(null,c__17596__auto__);
var b__57681 = cljs.core.chunk_buffer.call(null,size__17597__auto__);
if((function (){var i__57680 = (0);
while(true){
if((i__57680 < size__17597__auto__)){
var x = cljs.core._nth.call(null,c__17596__auto__,i__57680);
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__57681),puzzle_roguelike$components$map_view_$_iter__57676_$_iter__57678.call(null,cljs.core.chunk_rest.call(null,s__57679__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__57681),null);
}
} else {
var x = cljs.core.first.call(null,s__57679__$2);
var tile = puzzle_roguelike.map.get_tile_at.call(null,tiles,x,y);
var enemy = cljs.core.get.call(null,enemies,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [x,y], null));
var item = cljs.core.get.call(null,items,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [x,y], null));
var item_QMARK_ = cljs.core.contains_QMARK_.call(null,items,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [x,y], null));
...
,puzzle_roguelike$components$map_view_$_iter__57676_$_iter__57678.call(null,cljs.core.rest.call(null,s__57679__$2)));
}
} else {
return null;
}
...
});})(s__57677__$1,y,xs__4977__auto__,temp__4425__auto__,vec__57674,width,height,vec__57675,player_x,player_y,pixel_position))
,null,null));
});})(s__57677__$1,y,xs__4977__auto__,temp__4425__auto__,vec__57674,width,height,vec__57675,player_x,player_y,pixel_position))
;
...
return cljs.core.concat.call(null,fs__17595__auto__,puzzle_roguelike$components$map_view_$_iter__57676.call(null,cljs.core.rest.call(null,s__57677__$1)));
} else {
var G__57683 = cljs.core.rest.call(null,s__57677__$1);
s__57677__$1 = G__57683;
continue;
}
} else {
return null;
...
});})(vec__57674,width,height,vec__57675,player_x,player_y,pixel_position))
,null,null));
});})(vec__57674,width,height,vec__57675,player_x,player_y,pixel_position))
;
