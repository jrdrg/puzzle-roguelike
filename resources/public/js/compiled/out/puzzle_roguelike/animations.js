...
puzzle_roguelike.animations.deg_180 = Math.PI;
puzzle_roguelike.animations.deg_90 = (Math.PI / (2));
puzzle_roguelike.animations.update_BANG_ = (function puzzle_roguelike$animations$update_BANG_(delta){
return cljs.core.swap_BANG_.call(null,puzzle_roguelike.state.game_state,cljs.core.update_in,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"player","player",-97687400),new cljs.core.Keyword(null,"food","food",1842183121)], null),(function (p1__58759_SHARP_){
return Math.round((p1__58759_SHARP_ + 0.1));
}));
});
...
var delta_58760 = (ts - (function (){var or__16826__auto__ = cljs.core.deref.call(null,puzzle_roguelike.animations.last_ts);
...
puzzle_roguelike.animations.update_BANG_.call(null,delta_58760);
} else {
}
...
//# sourceMappingURL=animations.js.map?rel=1453728832523