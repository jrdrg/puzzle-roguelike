...
return cljs.core.swap_BANG_.call(null,puzzle_roguelike.state.game_state,cljs.core.update_in,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"player","player",-97687400),new cljs.core.Keyword(null,"food","food",1842183121)], null),(function (p1__59502_SHARP_){
return Math.round((p1__59502_SHARP_ + 0.1));
}));
});
...
var delta_59503 = (ts - (function (){var or__16826__auto__ = cljs.core.deref.call(null,puzzle_roguelike.animations.last_ts);
...
puzzle_roguelike.animations.update_BANG_.call(null,delta_59503);
} else {
}
...
//# sourceMappingURL=animations.js.map?rel=1454505522195